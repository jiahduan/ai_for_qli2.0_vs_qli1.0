...
| 分类 | 主题文件 |
|---|---|
| System_Architecture | [Security_Architecture](output/System_Architecture/Security_Architecture.md) · [Yocto](output/System_Architecture/Yocto.md) · [Distro_Version](output/System_Architecture/Distro_Version.md) · [Kernel_Code_Architecture](output/System_Architecture/Kernel_Code_Architecture.md) · [RT](output/System_Architecture/RT.md) · [Overlay](output/System_Architecture/Overlay.md) · [Display](output/System_Architecture/Display.md) · [Camera](output/System_Architecture/Camera.md) · [Audio](output/System_Architecture/Audio.md) · [Graphics](output/System_Architecture/Graphics.md) · [WiFi_BT](output/System_Architecture/WiFi_BT.md) |
| Boot_Architecture | [Partition_Layout](output/Boot_Architecture/Partition_Layout.md) · [Boot_Flow](output/Boot_Architecture/Boot_Flow.md) · [Bootloader](output/Boot_Architecture/Bootloader.md) · [Bootargs](output/Boot_Architecture/Bootargs.md) · [systemd](output/Boot_Architecture/systemd_.md) |
| Build_Architecture | [Build_Environment](output/Build_Architecture/Build_Environment.md) · [Build_Tools](output/Build_Architecture/Build_Tools.md) · [Bitbake_Version](output/Build_Architecture/Bitbake_Version.md) · [Toolchain](output/Build_Architecture/Toolchain.md) · [Kernel_Build](output/Build_Architecture/Kernel_Build.md) · [SDK_eSDK](output/Build_Architecture/SDK_eSDK.md) |
| Code_Composition | [Code_Sync_Method](output/Code_Composition/Code_Sync_Method.md) · [Code_Repository](output/Code_Composition/Code_Repository.md) · [Layer_Architecture](output/Code_Composition/Layer_Architecture.md) · [Source_Code_Structure](output/Code_Composition/Source_Code_Structure.md) · [Branch_Management](output/Code_Composition/Branch_Management.md) · [Patch_Management](output/Code_Composition/Patch_Management.md) · [HY11_HY22](output/Code_Composition/HY11_HY22.md) |
| Platform_Features | [Log_System](output/Platform_Features/Log_System.md) · [OTA_Mechanism](output/Platform_Features/OTA_Mechanism.md) · [Code_Submission](output/Platform_Features/Code_Submission.md) · [Flash_Process](output/Platform_Features/Flash_Process.md) |
