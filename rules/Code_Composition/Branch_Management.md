...
- **关键双侧目录/文件锚点**:
  - QLI1.0:`.repo/manifests/default.xml`(manifest revision字段);子仓库HEAD抽样`qc/display-kernel.lnx/cd`、`qc/camx.lnx/cd`、`qc/wlan-cmn.driver.lnx/cd`、`qc/audio-ahal-handset.lnx/cd`、`qc/gfx-kernel.lnx/cd`、`src/security/securemsm`、`poky`、`poky/meta-qti-bsp`
