...
> 本文件对应产出文档 [output/Build_Architecture/Build_Tools/Build_Tools.md](../../output/Build_Architecture/Build_Tools/Build_Tools.md),与全部33份主题规则文件按本次目录重构选择的方式各自完整独立(7条强制规则全文一致,不做共享继承,变更时需同步维护;背景见[Scope_Section_Design.md](../../Scope_Section_Design.md))。全局工作流/与README关系见根目录[Methodology.md](../../Methodology.md)。
...
- **关键双侧目录/文件锚点**:
  - kas文件分布统计:meta-qcom(46个ci/kas yml)、meta-qcom-distro(36个)、meta-qcom-robotics-sdk(19个)、meta-security(21个)、meta-updater(10个)
  - 真正的整机构建主入口:`meta-qcom/ci/*.yml`(如`meta-qcom/ci/rb3gen2-core-kit.yml`)、`meta-qcom/ci/base.yml`(声明repos/machine/target/local_conf_header)、`meta-qcom-distro/ci/qcom-distro.yml`(被前者includes引用的distro片段层)
