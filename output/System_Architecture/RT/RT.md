...
- **明确排除**:
  - RT内核相对mainline/QLI1.0内核的源码血统、仓库治理主体(commit标签体系、庭院多仓vs单一mainline-first等通用内核治理层面的对比,不含PREEMPT_RT本身) ——见[Kernel_Code_Architecture](../Kernel_Code_Architecture/Kernel_Code_Architecture.md)
